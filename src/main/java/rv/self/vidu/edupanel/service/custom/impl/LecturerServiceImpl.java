package rv.self.vidu.edupanel.service.custom.impl;

import com.google.cloud.storage.Blob;
import com.google.cloud.storage.Bucket;
import com.google.cloud.storage.Storage;
import rv.self.vidu.edupanel.entity.Lecturer;
import rv.self.vidu.edupanel.entity.LinkedIn;
import rv.self.vidu.edupanel.entity.Picture;
import rv.self.vidu.edupanel.exception.AppException;
import rv.self.vidu.edupanel.repository.LecturerRepository;
import rv.self.vidu.edupanel.repository.LinkedInRepository;
import rv.self.vidu.edupanel.repository.PictureRepository;
import rv.self.vidu.edupanel.service.custom.LecturerService;
import rv.self.vidu.edupanel.service.util.Transformer;
